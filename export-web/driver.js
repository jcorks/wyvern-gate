(function() {
    ...
    */
    ...
    const matteList = [
        ...
        "game_class.inletset.mt",
        "game_class.inventory.mt",
        "game_class.item.improvement.mt",
        "game_class.landmarkevent_cavebat.mt",
        "game_class.landmarkevent_chair.mt",
        "game_class.landmarkevent_creatureencounters.mt",
        "game_class.landmarkevent_dungeonencounters.mt",
        "game_class.landmarkevent_flamingskull.mt",
        "game_class.landmarkevent_giantflea.mt",
        "game_class.landmarkevent_gnome.mt",
        "game_class.landmarkevent_goldslime.mt",
        "game_class.landmarkevent_itemspecter.mt",
        "game_class.landmarkevent_mimic.mt",
        "game_class.landmarkevent_mobilemushroom.mt",
        "game_class.landmarkevent_monolith.mt",
        "game_class.landmarkevent_shadowling.mt",
        "game_class.landmarkevent_skeleton.mt",
        "game_class.landmarkevent_slime.mt",
        ...
        "game_database.artsterm.mt",
        "game_database.book.mt",
        ...
        "game_function.tabbedchoices.mt",
        "game_function.trap.mt",
        "game_mutator.arts.mt",
        "game_mutator.entityquality.mt",
        "game_mutator.islandevent.mt",
        "game_mutator.island.mt",
        "game_mutator.item.edible.mt",
        ...
        "game_scenario.therogue.charactercreator.mt",
        "game_scenario.therogue.class.mt",
        "game_scenario.therogue.database.mt",
        "game_scenario.therogue.mt",
        "game_scenario.thesurvivor.mt",
        "game_scenario.thetrader.mt",
        "game_singleton.canvas.mt",
        "game_singleton.commoninteractions.mt",
        "game_singleton.databaseitemmutatorclass.mt",
        "game_singleton.dungeonmap.mt",
        "game_singleton.gamblist.mt",
        "game_singleton.hud.mt",
