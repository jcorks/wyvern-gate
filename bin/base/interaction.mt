...
@:chooseMultiple = import(:'base/widgets/choosemultiple.mt');
@:lootget = import(:'base/widgets/lootget.mt');
      ...
      windowEvent.queueChoices(
        ...
        onChoice::(choice) {
          ...
          if (location.data.trapped == true) ::<= {
            ...
            (import(module:'base/map/trap.mt'))(location, party, whom);
            @:world = import(module:'base/world.mt')
                    ...
                    gamblist.playGame(onFinish::(partyWins) {
                      ...
                      windowEvent.queueChoices(
                        ...
                        onChoice::(choice) {
                          ...
                          @:pickItemInv = (import(module:'base/widgets/pickitem.mt'));
                          pickItemInv(
                            canCancel : false,
...
Interaction.newEntry(
  data : {
    ...
    isAvailable ::(location, party) <- true,
    interact ::(location, party) {
      party.members[0].addEffect(
        from: party.members[0],
        id: 'base:access-bank',
        durationTurns:1
      );
    }
...
Interaction.newEntry(
  data : {
    ...
    isAvailable ::(location, party) <- true,
    interact ::(location, party) {
      import(:'base/quest/guild.mt')(location, party);
    }
  }
) 
