...
return ::(canCancel => Boolean, onPick => Function, leftWeight, topWeight, prompt, onGetPrompt, showGold, goldMultiplier) {
    ...
    windowEvent.queueChoices(
        ...
        prompt: if (prompt == empty) 'Choose an equipped item:' else prompt => String,
